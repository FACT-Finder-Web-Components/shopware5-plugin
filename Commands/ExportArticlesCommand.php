...
class ExportArticlesCommand extends ShopwareCommand
{
    ...
    private const CUSTOMER_GROUP_ARGUMENT = 'customer_group';
    ...
    protected function configure()
    {
        ...
        $this->addArgument(self::CUSTOMER_GROUP_ARGUMENT, InputArgument::OPTIONAL, 'Customer group used for export', 1);
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $shopEmulation->emulateShop((int) $input->getArgument(self::SHOP_ID_ARGUMENT), (int) $input->getArgument(self::CUSTOMER_GROUP_ARGUMENT), function () use ($input, $output) {
